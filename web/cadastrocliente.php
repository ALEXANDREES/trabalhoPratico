...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>Cadastro de Cleintes</title>
  ...
  <div class="row">
    ...
    <div class="col-sm-4"></div>
         ...
         <div class="col-sm-8">
            ...
            <button type="button" id ="modalb" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">Cadastrar</button>
     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
         ...
         <div class="modal-content">
             ...
             <div class="modal-header">
                 ...
                 <h5 class="modal-title" id="exampleModalLongTitle">Cadastro de Clientes</h5>
